...
const Faq_MarksheetPrint_2018 = () => {
  ...
  return (
    <div className="Faq_MarksheetPrint_wrapper_2018">
      {/* PDF background */}
      <div className="pdf-bg">
        <Document file="/Faqunia Mark 18-22.pdf" onLoadSuccess={onLoadSuccess}>
          <Page
            pageNumber={1}
            width={720}
      ...
      {/* 🎓 Certificate Overlay */}
      <div className="Faq_MarksheetPrint_2018">
        {/* 🧾 Student Information */}
...
export default Faq_MarksheetPrint_2018;
