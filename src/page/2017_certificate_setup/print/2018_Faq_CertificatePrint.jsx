...
import './2018_Faq_CertificatePrint.scss';
...
const Faq_CertificatePrint_2018 = () => {
  ...
  return (
    <div className="Faq_CertificatePrint-wrapper_2018">
      {/* PDF background */}
      <div className="pdf-bg">
        <Document
          file="/Faq Certificate 18-22.pdf"
      ...
      {/* 🎓 Certificate Overlay */}
      <div className="Faq_CertificatePrint_2018">
        {/* 🧾 Student Information */}
...
export default Faq_CertificatePrint_2018;
